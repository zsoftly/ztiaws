...
func init() {
	...
	ssmCmd.AddCommand(ssmEmergencyCleanupCmd)

	// Add region flag to all SSM commands
	for _, cmd := range []*cobra.Command{ssmConnectCmd, ssmListCmd, ssmCommandCmd, ssmUploadCmd, ssmDownloadCmd, ssmForwardCmd, ssmStatusCmd, ssmCleanupCmd, ssmEmergencyCleanupCmd} {
